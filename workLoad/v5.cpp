...
class HybridWorkLoadEstimatorStrategy // ne connait pas SAMRAI
{
    public:
...
class ConcreteHybridWorkLoadEstimatorStrategy_NPPC : public HybridWorkLoadEstimatorStrategy // c'est lui seul qui sait comment faire
{
    public:
...
class HybridWorkLoadEstimator
{
    public:
        ...
        void estimate(double* wl, PHARE::core::Ions const& ions) {
            // loop sur le level sur tout les patchs qu'il contient
